...
public class CipherSpi extends BaseCipherSpi {
            ...
            throws NoSuchPaddingException
    {
        ...
        cipher = new OAEPEncoding(new SRABlindedEngine(), digest, ((PSource.PSpecified)pSpec.getPSource()).getValue());
        paramSpec = pSpec;
    }
            ...
            throws NoSuchPaddingException
    {
        ...
        {
            cipher = new SRABlindedEngine();
        }
        else if (pad.equals("PKCS1PADDING"))
        {
            cipher = new PKCS1Encoding(new SRABlindedEngine());
        }
        else if (pad.equals("ISO9796-1PADDING"))
        {
            cipher = new ISO9796d1Encoding(new SRABlindedEngine());
        }
            ...
            throws InvalidKeyException, InvalidAlgorithmParameterException
    {
        ...
        if (params == null || params instanceof OAEPParameterSpec)
        {
            ...
            if (params != null)
            {
                ...
                cipher = new OAEPEncoding(new SRABlindedEngine(), digest, mgfDigest, ((PSource.PSpecified)spec.getPSource()).getValue());
            }
        }
        else
        {
        ...
        if (!(cipher instanceof SRABlindedEngine))
        {
            if (random != null)
            {
            ...
            throws InvalidKeyException
    {
        ...
        catch (InvalidAlgorithmParameterException e)
        {
            ...
            throw new InvalidKeyException("Eeeek! *giggedy* " + e.toString(), e);
        }
    }
            ...
            extends CipherSpi
    {
        ...
        {
            super(new PKCS1Encoding(new SRABlindedEngine()));
        }
    }
            ...
            extends CipherSpi
    {
        ...
        {
            super(false, true, new PKCS1Encoding(new SRABlindedEngine()));
        }
    }
            ...
            extends CipherSpi
    {
        ...
        {
            super(true, false, new PKCS1Encoding(new SRABlindedEngine()));
        }
    }
            ...
            extends CipherSpi
    {
        ...
        {
            super(new ISO9796d1Encoding(new SRABlindedEngine()));
        }
    }
}